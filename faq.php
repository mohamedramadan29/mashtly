...
$description = 'الأسئلة الشائعة استكشف هذه الصفحة في متجر مشتلي للحصول على إجابات تفصيلية حول الشحن، الدفع، استرجاع المنتجات، واستخدام الموقع. حلول سريعة لجميع استفساراتك';
include "init.php";
?>

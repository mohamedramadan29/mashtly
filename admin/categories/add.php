...
if (isset($_POST['add_cat'])) {
    ...
    if (empty($formerror)) {
        $stmt = $connect->prepare("INSERT INTO categories (parent_id , name, slug,image,description,tags,main_category)
        VALUES (:zparent,:zname,:zslug,:zimage,:zdesc,:ztags,:zmain_category)");
        $stmt->execute(array(
            "zparent" => $parent,
            "zname" => $name,
            "zslug" => $slug,

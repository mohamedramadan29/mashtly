...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark"> النباتات الزراعية </h1>
            </div>
            <!-- /.col -->
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-left">
                    <li class="breadcrumb-item"><a href="main.php?dir=dashboard&page=dashboard">الرئيسية</a></li>
                    <li class="breadcrumb-item active"> النباتات الزراعية </li>
                </ol>
            </div>
            <!-- /.col -->
        </div>
                                    ...
                                    <table class="table table-striped table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            $query = "
                                                    ...
                                                    JOIN categories c_main ON p.cat_id = c_main.id
                                                    LEFT JOIN categories c_sub ON FIND_IN_SET(c_sub.id, p.more_cat)
                                                    WHERE (c_main.main_category = 1 OR c_sub.main_category = 1)
                                                    ORDER BY p.id DESC
                                                ";
                                                        ...
                                                        ?>
                                                            ...
                                                            if ($count_var > 0) {
                                                                foreach ($details2 as $detil) {
                                                                    echo $detil['vartions_name'] . "=>".  $detil['price'] . ' ريال  '.
                                                                    "</br>";
                                                                }
                                                            } else {
                                                                echo "منتج بسيط";

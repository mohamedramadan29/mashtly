    ...
    if (empty($formerror)) {
        ...
        if ($vartions_name > 0) {
            for ($i = 0; $i < count($vartions_name); $i++) {
                ...
                $vartions_price =  $vartions_price[$i];
                //////////// attribute images //////////////
                ...
                $main_image_uploaded = $image_alt_name;
                move_uploaded_file(
                    $image_temp,
...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark"> اضافة منتج Add Vartions </h1>
            </div>
            <!-- /.col -->
            <div class="col-sm-6">
                ...
                <div class="col-md-12">
                    <div class="card card-primary">
                        <div class="card-body">
                            ...
                            <p class="btn btn-success" id="verify_variations"> تاكيد المتغيرات </p>
                            <script>

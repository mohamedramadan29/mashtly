            ...
            <div class="col-lg-3 col-6">
                ...
                <div class="small-box bg-danger">
                    <div class="inner">
                        ...
                        <p class="text-bold"> عدد الطلبات  </p>
                    </div>
                    <div class="icon">
            ...
            <div class='col-lg-6'>
                ...
                <div class="card">
                    ...
                    <div class="card-body p-0">
                        <canvas id="orderschart" style="width:100%;max-width:700px;height:485px"></canvas>
                        <ul style="margin-right: 10px; display:none" class="list-unstyled products_report">
                            <style>
                                .products_report li {

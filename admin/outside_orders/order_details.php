...
?>
  ...
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark"> تفاصيل الطلب الخارجي </h1>
        </div>
        <!-- /.col -->
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-left">
            <li class="breadcrumb-item"><a href="main.php?dir=dashboard&page=dashboard">الرئيسية</a></li>
            <li class="breadcrumb-item active"> تفاصيل الطلب الخارجي </li>
          </ol>
        </div>
        <!-- /.col -->
      </div>
                  ...
                  <form action="" method="post">
                    <div class="row">
                      ...
                      <div class="col-lg-6">
                        ...
                        <div class="form-group">
                          <p class="badge badge-secondary" style="font-size: 16px;"> سعر الشحن المبدئي::: </p>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <?php
                        ?>
                        <span class="text-strong"> <strong> <?php echo $count_outsideserviceside ?> </strong> </span>
                      </div>
                      <div class="form-group">

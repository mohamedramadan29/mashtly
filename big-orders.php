...
$description = 'خدمة الطلبات الكبيرة للمؤسسات والشركات لشراء النباتات والمستلزمات الزراعية، مع خيارات متنوعة من المنتجات المختلفة، يمكن تقديم الطلب عبر تعبئة النموذج فى مشتلي';
include "init.php";
